									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createProductURL" value="/quan-tri/gio-hang/chinh-sua"/>
												<a flag="info"
											...
											<table class="table table-bordered">
												<thead>
													<tr>
														...
														<th>Tên sản phẩm</th>	
														<th>Ảnh</th>
														<th>Sản phẩm thuộc giỏ hàng của</th>
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>${item.userName}</td>
															<td>
																<c:url var="updateProductURL" value="/quan-tri/gio-hang/chinh-sua">
			...
			function deleteNew(data) {
		        $.ajax({
		            ...
		            success: function (result) {		            	
		               window.location.href = "${productAddURL}?page=1&limit=5&message=delete_success"; 	         
		            },
