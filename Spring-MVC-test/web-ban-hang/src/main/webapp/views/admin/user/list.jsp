...
<html>
	...
	<body>
		...
		<form action="<c:url value='/quan-tri/user/danh-sach'/>" id="formSubmit" method="get">
									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createProductURL" value="/quan-tri/user/chinh-sua"/>
												<a flag="info"
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td>
																<c:url var="updateProductURL" value="/quan-tri/user/chinh-sua">
