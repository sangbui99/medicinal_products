...
<html>
	...
	<body>
		...
		<form action="<c:url value='/quan-tri/chi-tiet-don-hang/danh-sach'/>" id="formSubmit" method="get">
									...
									<div class="table-btn-controls">
										<div class="pull-right tableTools-container">
											<div class="dt-buttons btn-overlap btn-group">
												<c:url var="createProductURL" value="/quan-tri/chi-tiet-don-hang/chinh-sua"/>
												<a flag="info"
												...
												<tbody>
													<c:forEach var="item" items="${model.listResult}">
														<tr>
															...
															<td><img class="card-img-top" src="<c:url value='/template/web/images/${item.codeImg}'/>" width="120px" alt=""></td>
															<td>${item.price}</td>
															<td>${item.number}</td>  	 
															<td>
																<c:url var="updateProductURL" value="/quan-tri/chi-tiet-don-hang/chinh-sua">
			...
			function deleteNew(data) {
		        $.ajax({
		            ...
		            success: function (result) {		            	
		               window.location.href = "${payDetailURL}?page=1&limit=10&message=delete_success"; 	         
		            },
